...
const DrawerLink = ({ href, text, iconName }) => {
  ...
  const isActive = segments[segments.length - 1] === href.split('/').pop();
...
export default function RightDrawer() {
  ...
  return (
    <View style={[StyleSheet.absoluteFill, { zIndex: 9999 }]}>
      <Animated.View style={[{ ...StyleSheet.absoluteFillObject, opacity: fade, backgroundColor: "rgba(0,0,0,0.5)" }]}>
      ...
      <Animated.View style={[styles.drawerPanel, { transform: [{ translateX: slideX }] }]}>
        ...
        <View style={styles.drawerContent}>
          ...
          <DrawerLink href="/placeholder" text="Dashboard Overview" iconName="grid-outline" />
